...
function Submitted() { const { caseId } = useParams(); return <div className="center"><h1>Report successfully submitted</h1><p>Tracking ID: {caseId}</p><a className="button primary" href={`/cases/${caseId}`}>Track My Case</a></div> }
